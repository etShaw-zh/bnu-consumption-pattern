...
generateReportBtn.onclick = function (event) {
    ...
    // document.getElementsByClassName('table-scrollable no-wrap')[0].appendChild(drawMap(mapContainer));
    event.preventDefault();
}
// Append the button to the page
...
function analysisTableData(tableData) {
    ...
    const dfByMerchant = dfAddCloumn.groupBy(consumption => consumption.merchant);
    var data = []
